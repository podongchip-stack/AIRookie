const tokens = {
  ...
  "colors.brand": {
    "value": "var(--colors-amber-500)",
    "variable": "var(--colors-brand)"
  },
  "colors.brand.emphasis": {
    "value": "var(--colors-amber-600)",
    "variable": "var(--colors-brand-emphasis)"
  },
  "colors.source.ai": {
    "value": "var(--colors-violet-600)",
    "variable": "var(--colors-source-ai)"
  },
  "colors.source.ai.subtle": {
    "value": "var(--colors-violet-100)",
    "variable": "var(--colors-source-ai\\.subtle)"
  },
  "colors.source.rule": {
    "value": "var(--colors-blue-600)",
    "variable": "var(--colors-source-rule)"
  },
  "colors.source.rule.subtle": {
    "value": "var(--colors-blue-100)",
    "variable": "var(--colors-source-rule\\.subtle)"
  },
  "colors.severity.high": {
    "value": "var(--colors-red-600)",
    "variable": "var(--colors-severity-high)"
  },
  "colors.severity.high.subtle": {
    "value": "var(--colors-red-100)",
    "variable": "var(--colors-severity-high\\.subtle)"
  },
  "colors.severity.medium": {
    "value": "var(--colors-orange-600)",
    "variable": "var(--colors-severity-medium)"
  },
  "colors.severity.medium.subtle": {
    "value": "var(--colors-orange-100)",
    "variable": "var(--colors-severity-medium\\.subtle)"
  },
  "colors.severity.low": {
    "value": "var(--colors-green-600)",
    "variable": "var(--colors-severity-low)"
  },
  "colors.severity.low.subtle": {
    "value": "var(--colors-green-100)",
    "variable": "var(--colors-severity-low\\.subtle)"
  },
  "colors.hospitalStatus.pending": {
    "value": "var(--colors-gray-500)",
    "variable": "var(--colors-hospital-status-pending)"
  },
  "colors.hospitalStatus.pending.subtle": {
    "value": "var(--colors-gray-100)",
    "variable": "var(--colors-hospital-status-pending\\.subtle)"
  },
  "colors.hospitalStatus.approved": {
    "value": "var(--colors-blue-600)",
    "variable": "var(--colors-hospital-status-approved)"
  },
  "colors.hospitalStatus.approved.subtle": {
    "value": "var(--colors-blue-100)",
    "variable": "var(--colors-hospital-status-approved\\.subtle)"
  },
  "colors.hospitalStatus.rejected": {
    "value": "var(--colors-red-600)",
    "variable": "var(--colors-hospital-status-rejected)"
  },
  "colors.hospitalStatus.rejected.subtle": {
    "value": "var(--colors-red-100)",
    "variable": "var(--colors-hospital-status-rejected\\.subtle)"
  },
  "colors.hospitalStatus.confirmed": {
    "value": "var(--colors-green-600)",
    "variable": "var(--colors-hospital-status-confirmed)"
  },
  "colors.hospitalStatus.confirmed.subtle": {
    "value": "var(--colors-green-100)",
    "variable": "var(--colors-hospital-status-confirmed\\.subtle)"
  },
  "spacing.-1": {
  ...
  "colors.colorPalette.rule": {
    "value": "var(--colors-color-palette-rule)",
    "variable": "var(--colors-color-palette-rule)"
  },
  "colors.colorPalette.rule.subtle": {
    "value": "var(--colors-color-palette-rule\\.subtle)",
    "variable": "var(--colors-color-palette-rule\\.subtle)"
  },
  "colors.colorPalette.high": {
    "value": "var(--colors-color-palette-high)",
    "variable": "var(--colors-color-palette-high)"
  },
  "colors.colorPalette.high.subtle": {
    "value": "var(--colors-color-palette-high\\.subtle)",
    "variable": "var(--colors-color-palette-high\\.subtle)"
  },
  "colors.colorPalette.medium": {
    "value": "var(--colors-color-palette-medium)",
    "variable": "var(--colors-color-palette-medium)"
  },
  "colors.colorPalette.medium.subtle": {
    "value": "var(--colors-color-palette-medium\\.subtle)",
    "variable": "var(--colors-color-palette-medium\\.subtle)"
  },
  ...
  "colors.colorPalette.low.subtle": {
    "value": "var(--colors-color-palette-low\\.subtle)",
    "variable": "var(--colors-color-palette-low\\.subtle)"
  },
  "colors.colorPalette.pending": {
    "value": "var(--colors-color-palette-pending)",
    "variable": "var(--colors-color-palette-pending)"
  },
  "colors.colorPalette.pending.subtle": {
    "value": "var(--colors-color-palette-pending\\.subtle)",
    "variable": "var(--colors-color-palette-pending\\.subtle)"
  },
  "colors.colorPalette.approved": {
    "value": "var(--colors-color-palette-approved)",
    "variable": "var(--colors-color-palette-approved)"
  },
  "colors.colorPalette.approved.subtle": {
    "value": "var(--colors-color-palette-approved\\.subtle)",
    "variable": "var(--colors-color-palette-approved\\.subtle)"
  },
  "colors.colorPalette.rejected": {
    "value": "var(--colors-color-palette-rejected)",
    "variable": "var(--colors-color-palette-rejected)"
  },
  "colors.colorPalette.rejected.subtle": {
    "value": "var(--colors-color-palette-rejected\\.subtle)",
    "variable": "var(--colors-color-palette-rejected\\.subtle)"
  },
  "colors.colorPalette.confirmed": {
    "value": "var(--colors-color-palette-confirmed)",
    "variable": "var(--colors-color-palette-confirmed)"
  },
  "colors.colorPalette.confirmed.subtle": {
    "value": "var(--colors-color-palette-confirmed\\.subtle)",
    "variable": "var(--colors-color-palette-confirmed\\.subtle)"
  }
}
